...
?>
    ...
    <div class="recent-news">
        <div id="recent-news-slides">
                    
            <?php $totalposts =  $total_posts_found; ?>
            <?php $counter = 1; ?>
    ...
    <div class="prev-next-container"><div id="news-slides-prev"><span class="icon-drw-chevron-left"></span></div><div id="news-slides-next"><span class="icon-drw-chevron-right"></span></div></div>
</div>
